            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <?= $form->field($model, 'address',
                        ...
                        'ng-model' => 'address',
                        'class' => ($model->address) ? 'ng-dirty fix-width-material-input' : '']) ?>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    <?= $form->field($model, 'imagePhoto')->widget(FileInput::className(), [
                        ...
                        'pluginOptions' => [
                            ...
                            'showUpload' => false,
                            'initialPreview' => [
                                Html::img("@web/uploads/image/" . $model->image_Photo, ['class' => 'img-responsive'])
                            ]
                        ]
                    ]); ?>
                </div>
                <div class="col-md-6 col-xs-12">
                    <?= $form->field($model, 'imageLicense')->widget(FileInput::className(), [
                        ...
                        'pluginOptions' => [
                            ...
                            'showUpload' => false,
                            'initialPreview' => [
                                Html::img("@web/uploads/image/" . $model->image_license, ['class' => 'img-responsive'])
                            ]
                        ]
                    ]) ?>
                </div>
